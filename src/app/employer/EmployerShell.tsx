    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="lg:hidden sticky top-0 z-30 bg-white border-b border-divider px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] bg-accent-bg text-accent px-1.5 py-0.5 rounded font-medium">Employer</span>
        </div>
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-[272px] max-w-[80vw] bg-white shadow-2xl flex flex-col animate-in slide-in-from-left duration-300">
            ...
            <div className="px-4 py-4 border-b border-divider">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-accent-bg flex items-center justify-center text-[12px] font-semibold text-accent shrink-0">
                  {initials}
                </div>
                <div className="min-w-0">
                  ...
                  <span className="inline-flex items-center gap-1 text-[10px] bg-accent-bg text-accent px-1.5 py-0.5 rounded font-medium mt-1">
