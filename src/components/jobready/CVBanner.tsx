    ...
    return (
      <section className="bg-ink py-6">
        <div className="max-w-6xl mx-auto px-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <Link href="/articles?category=CV+Writing" className="shrink-0 bg-accent text-white text-[13px] font-bold px-5 py-2.5 rounded-lg hover:bg-accent-dark transition-colors">
            View Packages →
          </Link>
        </div>
      </section>
  ...
  return (
    <section className="bg-accent-bg border-y border-accent/15 py-6">
      <div className="max-w-6xl mx-auto px-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <Link href="/articles?category=CV+Writing" className="shrink-0 bg-ink text-white text-[13px] font-medium px-5 py-2.5 rounded-lg hover:bg-ink/90 transition-colors">
          Get Started →
        </Link>
      </div>
    </section>
