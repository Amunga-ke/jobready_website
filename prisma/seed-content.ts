...
const LISTINGS: ListingDef[] = [
  ...
  },
  {
    ...
    experienceLevel: "Mid-level",
    workMode: "HYBRID",
    location: "Nairobi, Enterprise Road",
    countyName: "Nairobi",
  ...
  },
  {
    ...
    experienceLevel: "Entry-level",
    workMode: "ONSITE",
    location: "Nairobi, Various Venues",
    countyName: "Nairobi",
...
async function seedListings(companyMap: Map<string, string>) {
  ...
  for (const listing of LISTINGS) {
    ...
    const countyId = countyMap.get(listing.countyName) || null;
